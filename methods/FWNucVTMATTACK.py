...
def main(args):
    ...
    Metrics = {'dataset':args.dataset,'eps':args.eps,'nit':args.nit,'IOU':np.float64(fwnucl.iou_loss.detach().cpu().numpy()),'IOU_run':fwnucl.IOU_RUN,'nuc_norm_run':fwnucl.Nuc_NORM_RUN}
...
if __name__ == "__main__":
    ...
    for dataset,path_dataset,nit,eps,instance in product(Data,Path_Data,Nit,eps,instance):
        args = argparse.Namespace(
            ...
            nit = nit,
            eps=eps,
            save='/home/jacob/Repos/python/VideoAttacks/experiments/VTM-Data/'+instance+"/FWNucl",
            instance = instance
        )
        print(args.dataset)
        main(args) 