...
def main(args):
    ...
    plt.imshow(filter_perturbation(Result,0.01),cmap='hot')
...
if __name__ == "__main__":
    ...
    Data = ['EPFL_RLC']
    instance = ['cam0','cam1','cam2']#['View_001']
   # Save = ['/home/jacob/Repos/python/VideoAttacks/experiments/PETS09'+"/"+instance[0]]
    Path_Data = ["/home/jacob/datasets"]
    Nit = [50]
    rank = [0.5]#,0.5,1.0]#[0.1,0.5,1.0]
    #eps = [0.5,1.0,3.0]
    eps=[15.0]
    ...
    for dataset,path_dataset,nit,eps,rank,instance in product(Data,Path_Data,Nit,eps,rank,instance):
        args = argparse.Namespace(
            ...
            eps=eps,
            rank=rank,
            save='/home/jacob/Repos/python/VideoAttacks/experiments/EPFL'+"/"+instance+"/LoRaPGD",
            instance = instance
        )
        print(args.dataset)
        main(args) 
