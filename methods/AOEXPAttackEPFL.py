...
class AoEXP_Attack:
    ...
    def wrapper_func_p(self,x):
        ...
        try:
            ...
            self.IOU_RUN.append(self.iou_loss/len(self.data))
...
def main(args):
    ...
    Metrics = {'dataset':args.dataset,'l1':args.l1,'l2':args.l2,'k':args.k,'nit':args.nit,'IOU':l,'IOU_run':Aoexp_attack.IOU_RUN,'nuc_norm_run':Aoexp_attack.Nuc_NORM_RUN}
...
if __name__ == "__main__":
    ...
    Data = ['EPFL_RLC']
    instance = ['cam0','cam1','cam2']
    Path_Data = DATA_PATH
    
    Nit = [50]
    L1 = [0.75]
    frac = [100]
    k = ['top1',0.1,0.3,0.5,0.75,1.0] 
    DEVICE = torch.device('cuda:0')


    for dataset,path_dataset,nit,l1,frac,instance,k in product(Data,Path_Data,Nit,L1,frac,instance,k):
        args = argparse.Namespace(
            ...
            l1=l1,
            l2=0.005,
            save=REPO_PATH+"/experiments/EPFL"+"/"+instance+"/AO-Exp",
            instance = instance,
            k=k,
            DEVICE = DEVICE
        )
